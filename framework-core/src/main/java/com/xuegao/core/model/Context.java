...
//      * 全局参数
//      */
//     private ConcurrentMap<String, Object> globalParamMap = new ConcurrentHashMap<>();
//     /**
//      * 一次登录，一个会话id
//      */
...
//             log.warn("globalVariableMap put null key or null value,but it,s Forbid,please check your code!");
//             return;
//         }
